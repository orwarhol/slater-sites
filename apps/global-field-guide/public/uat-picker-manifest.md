...
| Item | Value |
|---|---|
| Total eligible images | 243 |
| Seed images (root-level, user-added) | 19 |
...
- The 19 seed images at the root level are freely-licensed real photos or AI-generated images added/generated by the product owner.
